export const colorCode = [
    ...
    },
    {
        indent: 2,
        tokens: [
            { type: 'prop', content: 'backgroundColor' },
            { type: 'operator', content: ": '" },
            { type: 'string', content: '#F6EA11' },
            { type: 'operator', content: "'" }
        ]
    },
    {
    ...
    },
    {
        ...
        tokens: [
            { type: 'punctuation', content: '<' },
            { type: 'tag', content: 'img' },
            { type: 'text', content: ' ' },
            { type: 'prop', content: 'src' },
            { type: 'operator', content: '={m} ' },
            { type: 'prop', content: 'alt' },
            { type: 'operator', content: '="Colores"' },
            { type: 'punctuation', content: ' />' }
        ]
    },
    {
