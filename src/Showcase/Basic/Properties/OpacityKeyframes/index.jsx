...
import { opacityKeyframesCode } from './data/codeSnippet';
...
function OpacityKeyframes() {
    const { title, subtitle, description } = opacityKeyframesContent;
    const [isModalOpen, setIsModalOpen] = useState(false);
    const { goToNext, goToPrev } = useCatalogNavigation('opacity-keyframes-motion');
        ...
        >
            ...
            {isModalOpen && (
                <SimpleModal onClose={() => setIsModalOpen(false)}>
                    <CodeBlock lines={opacityKeyframesCode} />
                </SimpleModal>
            )}
